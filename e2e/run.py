...
def raw(c: Config, ibc0: ChainId, ibc1: ChainId, port_id: PortId) -> Tuple[
    ClientId, ConnectionId, ChannelId, ClientId, ConnectionId, ChannelId]:
...
def main():
    ...
    ibc0_client_id, ibc0_conn_id, ibc0_chan_id, ibc1_client_id, ibc1_conn_id, ibc1_chan_id = raw(config, ibc0, ibc1,
                                                                                                 port_id)
    sleep(2.0)
