...
pub trait ChainEndpoint: Sized {
    ...
    fn build_connection_proofs_and_client_state(
        ...
        match message_type {
            ConnectionMsgType::OpenTry | ConnectionMsgType::OpenAck => {
                let (client_state_value, maybe_client_state_proof) = self
                    .query_client_state(
                ...
                let client_state_proof = maybe_client_state_proof
                    .expect(QUERY_PROOF_EXPECT_MSG);
                client_proof = Some(
    ...
    fn build_packet_proofs(
        ...
        let (maybe_packet_proof, channel_proof) = match packet_type {
            ...
            PacketMsgType::TimeoutOnClose => {
                let channel_proof = {
                    ...
                    let channel_merkle_proof = maybe_channel_proof
                        .expect(QUERY_PROOF_EXPECT_MSG);
                    Some(
        ...
        let proofs = Proofs::new(
                CommitmentProofBytes::try_from(packet_proof)
                    .map_err(Error::malformed_proof)?,
                None,
                None,
                channel_proof,
